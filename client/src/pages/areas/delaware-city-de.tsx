...
export default function DelawareCityDE() {
  const { data: properties = [] } = useQuery<Property[]>({
    queryKey: ['/api/properties/zip', DELAWARE_CITY_ZIP],
  });
  ...
  const neighborhoods = [
    { 
      ...
      description: "The heart of Delaware City, featuring historic row homes, brick sidewalks, and riverfront access. Perfect for buyers seeking character, charm, and walkability.",
      link: "https://delawarecity.delaware.gov",
      linkText: "Delaware City Historic Info"
    },
    { 
      name: "Fort DuPont Area",
      type: "Historic Redevelopment",
      description: "A rapidly developing area near the Fort DuPont complex, offering restored homes, new residential opportunities, and waterfront access points."
    },
    { 
      name: "Delaware City Marina Community",
      type: "Waterfront / Modern",
      description: "A scenic area offering marina access, nearby trails, and newer homes. Popular among boaters, outdoor enthusiasts, and those who want peaceful water views.",
      link: "https://www.delawarecitymarina.com",
      linkText: "Delaware City Marina"
    },
    { 
      name: "Polktown",
      type: "Established / Community-Focused",
      description: "A quiet residential area with traditional homes, open space, and easy access to Route 9. Ideal for buyers wanting stability and affordability."
    },
    { 
      name: "Delaware City Refuge Area",
      type: "Rural / Nature-Oriented",
      description: "Located near wildlife refuges and open land, this area appeals to buyers seeking space, nature access, and a quieter lifestyle.",
      link: "https://www.fws.gov/refuge",
      linkText: "Wildlife Refuge Overview"
    },
    { 
      name: "Fort Delaware Gateway Communities",
      type: "Scenic / Tourist-Friendly",
      description: "Housing near the ferry and park entrance offers convenience and access to one of Delaware's most visited historic attractions."
    }
  ];

  const highlights = [
    { icon: Landmark, title: "Historic Charm", desc: "Victorian architecture" },
    { icon: Car, title: "Fort Delaware", desc: "Historic state park" },
    { icon: GraduationCap, title: "Schools", desc: "Colonial School District" },
    { icon: TreePine, title: "Nature Access", desc: "River trails & parks" }
  ];
  ...
  return (
    <>
      ...
      <main>
          ...
          <div className="container mx-auto px-4">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6 text-center">
              <div>
                ...
                <div className="text-sm opacity-90">to New Castle</div>
              </div>
              <div>
              ...
              <div>
                ...
                <div className="text-sm opacity-90">Delaware River & Canal</div>
              </div>
              <div>
                <div className="text-2xl font-bold">Growing</div>
                <div className="text-sm opacity-90">Historic + Tourism</div>
              </div>
            </div>
          </div>
        </section>
            ...
            <div className="container mx-auto px-4 lg:px-6">
              <div className="text-center mb-12">
                <h2 className="text-3xl md:text-4xl font-bold mb-4">
                  {spotlightProperty.isRental ? 'Featured Rental' : 'Featured Home'} in Delaware City
                </h2>
        ...
        <section className="py-16">
          <div className="container mx-auto px-4 lg:px-6">
            <h2 className="text-3xl md:text-4xl font-bold text-center mb-12">Why Families Love Delaware City</h2>
        ...
        <section className="py-16 bg-secondary/30">
          <div className="container mx-auto px-4 lg:px-6">
            <div className="text-center mb-12">
              ...
              <p className="text-muted-foreground max-w-xl mx-auto">From historic townhomes to waterfront properties, Delaware City has options for every budget</p>
            </div>
            <div className="grid md:grid-cols-3 gap-6 max-w-4xl mx-auto">
              <Card className="overflow-hidden hover:shadow-xl transition-shadow">
                ...
                <CardContent className="pt-6 pb-6 text-center">
                  ...
                  <p className="text-muted-foreground text-sm">Townhomes, small detached homes, and established properties</p>
                </CardContent>
              </Card>
              <Card className="overflow-hidden hover:shadow-xl transition-shadow border-primary">
                <div className="h-3 bg-primary" />
                <CardContent className="pt-6 pb-6 text-center">
                  <div className="text-3xl font-bold text-primary mb-2">$330K–$425K</div>
                  <h3 className="font-semibold text-lg mb-2">Move-Up Homes</h3>
                  <p className="text-muted-foreground text-sm">Renovated historic homes, larger residences, and improved interiors</p>
                </CardContent>
              </Card>
              <Card className="overflow-hidden hover:shadow-xl transition-shadow">
                <div className="h-3 bg-amber-500" />
                <CardContent className="pt-6 pb-6 text-center">
                  <div className="text-3xl font-bold text-amber-600 mb-2">$450K+</div>
                  <h3 className="font-semibold text-lg mb-2">Luxury Homes</h3>
                  <p className="text-muted-foreground text-sm">Waterfront homes, new builds near the marina, and scenic properties</p>
                </CardContent>
              </Card>
            </div>
          </div>
        ...
        <section className="py-16 bg-secondary/30">
          <div className="container mx-auto px-4 lg:px-6">
            <div className="max-w-5xl mx-auto">
              ...
              <p className="text-muted-foreground text-center mb-12 max-w-2xl mx-auto">Explore some of Delaware City's most desirable communities, each offering its own character, amenities, and lifestyle benefits.</p>
          ...
          <div className="container mx-auto px-4 lg:px-6">
            <div className="max-w-4xl mx-auto">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                {[
                  { dest: "New Castle", time: "12 min" },
                  { dest: "Middletown", time: "18 min" },

  ...
  const schemas = [
    {
      ...
      description: "New urbanism community in Middletown, DE blending homes, shops, parks, and walkability with architectural charm and front-porch living.",
    ...
    },
    {
      ...
      name: "Demographic and Housing Profile for The Town of Whitehall, Middletown, Delaware",
      description: "US Census Bureau ACS 5-year estimates covering median household income, homeownership rates, and housing age data for The Town of Whitehall, Middletown, Delaware.",
    ...
    },
    {
      ...
      areaServed: { "@type": "Place", "@id": "https://hensleyshomes.com/areas/middletown-de/whitehall/#place" },
      knowsAbout: { "@type": "Place", "@id": "https://hensleyshomes.com/areas/middletown-de/whitehall/#place" },
    },
  ];

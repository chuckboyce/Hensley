...
export default function NewarkDE() {
  ...
  useEffect(() => {
    ...
    placeScript.id = 'newark-place-schema';
    placeScript.textContent = JSON.stringify({
      "@context": "https://schema.org",
      "@type": "Place",
      "@id": "https://hensleyshomes.com/areas/newark-de/#place",
      "name": "Newark, Delaware",
      "description": "Community guide for Newark, DE including neighborhoods, schools, University of Delaware, commutes, and insights from local Realtor Kevin Hensley.",
      "address": {
        "@type": "PostalAddress",
      ...
      "areaServed": "Newark, Delaware",
      "url": "https://hensleyshomes.com/areas/newark-de",
      "author": {
    ...
    breadcrumbScript.id = 'newark-de-breadcrumb-schema';
    breadcrumbScript.textContent = JSON.stringify({
      ...
      "itemListElement": [
        ...
        { "@type": "ListItem", "position": 3, "name": "Newark, Delaware", "item": "https://hensleyshomes.com/areas/newark-de" }
      ]
    });

    const existingPlace = document.getElementById('newark-place-schema');
    if (existingPlace) existingPlace.remove();
    const existingBreadcrumb = document.getElementById('newark-de-breadcrumb-schema');
    ...
    return () => {
      const el = document.getElementById('newark-place-schema');
      if (el) el.remove();
      const bc = document.getElementById('newark-de-breadcrumb-schema');
      if (bc) bc.remove();
    };
  }, []);

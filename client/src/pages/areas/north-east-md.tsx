...
export default function NorthEastMD() {
  const { data: properties = [] } = useQuery<Property[]>({
    queryKey: ['/api/properties/zip', NORTH_EAST_ZIP],
  });
  ...
  const highlights = [
    { icon: Landmark, title: "Waterfront Living", desc: "Marina & boat access" },
    { icon: ShoppingBag, title: "Main Street", desc: "Dining & boutiques" },
    { icon: GraduationCap, title: "Schools", desc: "Cecil County Public Schools" },
    { icon: TreePine, title: "Elk Neck Park", desc: "Beaches & nature trails" }
  ];
    ...
    <>
      ...
      <Breadcrumb 
        items={[
          ...
          { label: "North East, Maryland", current: true }
        ]}
      />
      <main>
        ...
        <section className="relative h-[50vh] min-h-[350px] flex items-center justify-center">
          <div 
            ...
            style={{ backgroundImage: `url(${northEastHero})` }}
          >
          ...
          <div className="container mx-auto px-4">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6 text-center">
              ...
              <div>
                ...
                <div className="text-sm opacity-90">Marinas & boating</div>
              </div>
              <div>
                <div className="text-2xl font-bold">Vibrant</div>
                <div className="text-sm opacity-90">Main Street charm</div>
              </div>
            </div>
          </div>
        </section>
            ...
            <div className="container mx-auto px-4 lg:px-6">
              <div className="text-center mb-12">
                <h2 className="text-3xl md:text-4xl font-bold mb-4">
                  {spotlightProperty.isRental ? 'Featured Rental' : 'Featured Home'} in North East
                </h2>
        ...
        <section className="py-16">
          <div className="container mx-auto px-4 lg:px-6">
            <h2 className="text-3xl md:text-4xl font-bold text-center mb-12">Why Families Love North East</h2>
        ...
        <section className="py-16 bg-secondary/30">
          <div className="container mx-auto px-4 lg:px-6">
            <div className="text-center mb-12">
              ...
              <p className="text-muted-foreground max-w-xl mx-auto">From waterfront condos to suburban homes, North East has options for every budget</p>
            </div>
            <div className="grid md:grid-cols-3 gap-6 max-w-4xl mx-auto">
              <Card className="overflow-hidden hover:shadow-xl transition-shadow">
                ...
                <CardContent className="pt-6 pb-6 text-center">
                  ...
                  <p className="text-muted-foreground text-sm">Townhomes and small single-family homes close to Route 40 or Main Street</p>
                </CardContent>
              </Card>
              <Card className="overflow-hidden hover:shadow-xl transition-shadow border-primary">
                ...
                <CardContent className="pt-6 pb-6 text-center">
                  ...
                  <p className="text-muted-foreground text-sm">Well‑kept subdivisions, newer builds, and homes with larger lots</p>
                </CardContent>
              </Card>
              <Card className="overflow-hidden hover:shadow-xl transition-shadow">
                ...
                <CardContent className="pt-6 pb-6 text-center">
                  ...
                  <p className="text-muted-foreground text-sm">Waterfront condos, river‑view homes, and custom builds</p>
                </CardContent>
              </Card>
            </div>
          </div>
        ...
        <section className="py-16 bg-secondary/30">
          <div className="container mx-auto px-4 lg:px-6">
            <div className="max-w-5xl mx-auto">
              ...
              <p className="text-muted-foreground text-center mb-12 max-w-2xl mx-auto">Explore some of North East's most desirable communities, each offering its own character, amenities, and lifestyle benefits.</p>
            ...
            <div className="max-w-4xl mx-auto">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                {[
                  ...
                  { dest: "Elkton, MD", time: "10 min" },
                  { dest: "Middletown, DE", time: "28 min" },
                  { dest: "Wilmington, DE", time: "40 min" }
                ].map((item) => (
                  <div key={item.dest}>

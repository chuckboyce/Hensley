...
export default function ChesapeakeCityMD() {
  const { data: properties = [] } = useQuery<Property[]>({
    queryKey: ['/api/properties/zip', CHESAPEAKE_CITY_ZIP],
  });
  ...
  useEffect(() => {
    ...
    placeScript.id = 'chesapeake-city-place-schema';
    placeScript.textContent = JSON.stringify({
      "@context": "https://schema.org",
      "@type": "Place",
      "@id": "https://hensleyshomes.com/areas/chesapeake-city-md/#place",
      "name": "Chesapeake City, Maryland",
      "description": "Community guide for Chesapeake City, MD including neighborhoods, waterfront properties, schools, commutes, and insights from local Realtor Kevin Hensley.",
      "address": {
        "@type": "PostalAddress",
      ...
      "areaServed": "Chesapeake City, Maryland",
      "url": "https://hensleyshomes.com/areas/chesapeake-city-md",
      "author": {
    ...
    breadcrumbScript.id = 'chesapeake-city-md-breadcrumb-schema';
    breadcrumbScript.textContent = JSON.stringify({
      ...
      "itemListElement": [
        ...
        },
        {
          ...
          "position": 3,
          "name": "Chesapeake City, Maryland",
          "item": "https://hensleyshomes.com/areas/chesapeake-city-md"
        }
      ]
    });
    
    const existingPlace = document.getElementById('chesapeake-city-place-schema');
    if (existingPlace) existingPlace.remove();
    const existingBreadcrumb = document.getElementById('chesapeake-city-md-breadcrumb-schema');
    ...
    return () => {
      const el = document.getElementById('chesapeake-city-place-schema');
      if (el) el.remove();
      const bc = document.getElementById('chesapeake-city-md-breadcrumb-schema');
      if (bc) bc.remove();
    };
  }, []);
  ...
  const neighborhoods = [
    { 
      name: "Historic South Chesapeake City", 
      type: "Waterfront / Historic",
      description: "The heart of town featuring Victorian architecture, boutique shops, canal-side restaurants, and walkable streets. Perfect for buyers drawn to charm and waterfront energy.",
      link: "https://www.chesapeakecity-md.gov",
      linkText: "Official Town Info"
    },
    { 
      name: "North Chesapeake City",
      type: "Established / Quiet",
      description: "Offers quieter residential living with traditional homes, small neighborhoods, and easy access via the iconic Chesapeake City Bridge."
    },
    { 
      name: "Canal District Homes",
      type: "Waterfront / Scenic",
      description: "Homes adjacent to the C&D Canal, many offering water views, marina access, and walkability to town attractions. Ideal for boaters and outdoor lovers."
    },
    { 
    ...
    { 
      name: "Bethel Road & Rural Surroundings",
      type: "Rural / Spacious",
      description: "Featuring farmland, wooded lots, and custom homes, this area appeals to buyers who want privacy, space, and country living near town."
    },
    { 
      name: "Canal View Estates (Nearby)",
      type: "Newer Construction",
      description: "A suburban-style development offering modern homes, sidewalks, and scenic surroundings just minutes from Chesapeake City."
    }
  ];

  const highlights = [
    { icon: ShoppingBag, title: "Historic District", desc: "Boutique shops & dining" },
    { icon: Car, title: "C&D Canal", desc: "Marina & boating hub" },
    { icon: GraduationCap, title: "Schools", desc: "Cecil County Public Schools" },
    { icon: Leaf, title: "Scenic Parks", desc: "Trail & waterfront views" }
  ];
    ...
    <>
      ...
      <Breadcrumb 
        items={[
          ...
          { label: "Chesapeake City, Maryland", current: true }
        ]}
      />
      <main>
          ...
          <div className="container mx-auto px-4">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6 text-center">
              <div>
                ...
                <div className="text-sm opacity-90">to Middletown, DE</div>
              </div>
              <div>
              ...
              <div>
                ...
                <div className="text-sm opacity-90">C&D Canal & Marina</div>
              </div>
              <div>
                <div className="text-2xl font-bold">Active</div>
                <div className="text-sm opacity-90">Boating Community</div>
              </div>
            </div>
          </div>
        </section>
            ...
            <div className="container mx-auto px-4 lg:px-6">
              <div className="text-center mb-12">
                <h2 className="text-3xl md:text-4xl font-bold mb-4">
                  {spotlightProperty.isRental ? 'Featured Rental' : 'Featured Home'} in Chesapeake City
                </h2>
        ...
        <section className="py-16">
          <div className="container mx-auto px-4 lg:px-6">
            <h2 className="text-3xl md:text-4xl font-bold text-center mb-12">Why Families Love Chesapeake City</h2>
        ...
        <section className="py-16 bg-secondary/30">
          <div className="container mx-auto px-4 lg:px-6">
            <div className="text-center mb-12">
              ...
              <p className="text-muted-foreground max-w-xl mx-auto">From waterfront townhomes to custom canal-view estates, Chesapeake City has options for every budget</p>
            </div>
            <div className="grid md:grid-cols-3 gap-6 max-w-4xl mx-auto">
              <Card className="overflow-hidden hover:shadow-xl transition-shadow">
                <div className="h-3 bg-blue-500" />
                <CardContent className="pt-6 pb-6 text-center">
                  <div className="text-3xl font-bold text-blue-600 mb-2">$300K–$360K</div>
                  <h3 className="font-semibold text-lg mb-2">Starter Homes</h3>
                  <p className="text-muted-foreground text-sm">Townhomes, cottages, and small single-family homes in and around town</p>
                </CardContent>
              </Card>
              <Card className="overflow-hidden hover:shadow-xl transition-shadow border-primary">
                <div className="h-3 bg-primary" />
                <CardContent className="pt-6 pb-6 text-center">
                  <div className="text-3xl font-bold text-primary mb-2">$375K–$500K</div>
                  <h3 className="font-semibold text-lg mb-2">Move-Up Homes</h3>
                  <p className="text-muted-foreground text-sm">Historic homes, updated residences, and scenic-edge properties</p>
                </CardContent>
              </Card>
              <Card className="overflow-hidden hover:shadow-xl transition-shadow">
                ...
                <CardContent className="pt-6 pb-6 text-center">
                  ...
                  <p className="text-muted-foreground text-sm">Waterfront homes, canal-view properties, and rural estates with acreage</p>
                </CardContent>
              </Card>
            </div>
          </div>
        ...
        <section className="py-16 bg-secondary/30">
          <div className="container mx-auto px-4 lg:px-6">
            <div className="max-w-5xl mx-auto">
              ...
              <p className="text-muted-foreground text-center mb-12 max-w-2xl mx-auto">Explore some of Chesapeake City's most desirable communities, each offering its own character, amenities, and lifestyle benefits.</p>
            ...
            <div className="max-w-4xl mx-auto">
              <div className="flex items-center gap-4 mb-8">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">Quick access to Route 213 and major destinations</p>
                </div>
              </div>
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                {[
                  { dest: "Middletown, DE", time: "15 min" },
                  { dest: "Elkton, MD", time: "12 min" },
